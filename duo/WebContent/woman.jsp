...
// 			document.msForm.submit();
			...
			$.ajax({			
				   type: "post",
		    url: "/duo/search?cmd=search&gender=남자",
		   dataType : "json",
				       ...
				       for (var i = 0; i < data.member.length; i++) {
						...
						var contents ='';
		                  contents += '<tr class="seltr">';
		                       ...
		                       contents +=     '<td id="img1" width="80" height="55"><img src="/duo/upload/'+pic+'" style="width:80px; height:55px;"/></td>';
		                  
		                       contents +=     '<td id="name1">'+name+'</td>';
		                       contents +=     '<td id="age1">'+age+' </td>';
		                       /* contents +=     '<td width="190" height="55" >직업: '+job+' </td>'; */

		                       contents += '<td id="detail1"><input type="button" id="selbtn" class="btn btn-default" value="상세" name="'+id+'" onclick="popup_win2($(this).next().val())"/> <input type="hidden" value="'+id+'" /></td>';
...
<!-- 							<table width="420" cellspacing="0" cellpadding="0" class='sel' id="sel" style="float:left;"> -->
							<table   class='sel' id="sel" style="float:left;">		
						...
						<tr>
						<td colspan="9"><input type="submit" id="more"class="btn btn-default" value="더보기" style="margin-left:530px;"/></td>
					</tr>
				</table>
				</div>
			</form>
